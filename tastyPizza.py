...
pizzas = {1: "vegetarian" , 2: "meaty" , 3: "pepperoni" , 4: "hawaiian"}
...
#    bill = 0
    ...
    while checkout:
        ...
        sizeChoice= input("What size do you want? small, medium, or large\n-> ")
        global bill
...
print("Thanks {} , your total cost is: ${:.2f} and your orders are as below:".format(custName, total_bill))
